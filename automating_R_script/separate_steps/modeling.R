...
fin_prices <- read_csv("C:/Users/cdawg/git_repos/py_hackaround/automating_R_script/data/fin_data.csv") %>% clean_names()
...
fin_pred_out %>% 
  ...
  write_csv("C:/Users/cdawg/git_repos/py_hackaround/automating_R_script/data/fin_forecast.csv")
